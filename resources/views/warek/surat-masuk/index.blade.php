<x-app-layout>
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {{-- Page Header --}}
            <x-page-header 
                title="Review Surat Masuk" 
                subtitle="Daftar surat yang menunggu proses review dari Anda."
            />
            ...
            <div class="table-card">
                ...
                <div class="px-5 py-4 border-b border-[#F1F5F9] bg-white">
                    <h3 class="text-[15px] font-bold text-[#0F172A]">Daftar Antrean Review</h3>
                </div>
