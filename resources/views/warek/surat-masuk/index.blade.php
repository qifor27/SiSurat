<x-app-layout>
    <div class="min-h-screen bg-[#F5F7FA] py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {{-- Page Header --}}
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-900">📋 Surat Menunggu Review</h1>
                <p class="text-sm text-gray-500 mt-1">Daftar surat masuk yang memerlukan review dan persetujuan Anda.</p>
            </div>
            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                ...
                @if($suratMasuk->isEmpty())
                    <div class="text-center py-16">
                        ...
                        <p class="text-lg font-medium text-gray-700">Tidak ada surat yang perlu di-review</p>
